                    ...
                    <div class="col-lg-12">
                        <div class="card-x bg-white">
                            <div class="card-body-x">
                                <div class="">
                                    <h3 class="">
                                        <font size="2px">Local Bank Transfer</font>
                                    </h3>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card-x">
                            ...
                            <div class="card-body-x">
                                <form action="{{ route('submit.localtrans') }}"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-2">
                                            <font size="2px">Receivers name</font>
                                        </label>
                                        <div class="col-lg-10">
                                    ...
                                    <!--<div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <input type="number" maxlength="50" class="form-control" name="amount"
                                                    required>
                                    ...
                                    <div class="text-right">
                                        <button type="button" data-toggle="modal" data-target="#modal-form"
                                            class="button btn" style="background-color: #17705a; color: #ffffff;">
