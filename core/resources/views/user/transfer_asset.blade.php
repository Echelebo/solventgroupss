...
@section('content')
    <div class="header pb-6 d-flex align-items-center"
        style="min-height: 500px; background-image: url({{ url('/') }}/asset/images/shutterstock_1145329577-scaled.jpg); background-size: cover; background-position: center top;">
        <!-- Mask -->
        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-lg-12 col-10">
                    ...
                    <a data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-neutral"><i
                            ...
                            <div class="modal-body p-0">
                                <div class="card bg-white border-0 mb-0">
                                    <div class="card-body px-lg-5 py-lg-5">
                                        <form action="{{ route('submit.transferasset') }}" method="post"
                                            id="modal-details">
                                            @csrf
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="number" name="acct_no" class="form-control"
                                                        required="">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <select class="form-control select" name="asset" id="asset_price"
                                                        ...
                                                        @foreach ($asset as $k => $val)
                                                            <option value="{{ $val->plan->id }}">{{ $val->plan->symbol }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                        ...
                                                        <div class="modal-body p-0">
                                                            <div class="card bg-white border-0 mb-0">
                                                                <div class="card-header bg-transparent pb-2ß">
                                                                    <div class="text-dark text-center mt-2 mb-3">Enter
                                                                        account pin to complete request</div>
                                                                </div>
                                                                <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ml--2">
                                        ...
                                        <span class="badge badge-pill badge-primary">Charge:
                                            {{ ($val->amount * $set->transfer_charge) / 100 }}{{ $val->plan->symbol }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
