...
@endif</p>
                                ...
                                <div >
                                    ...
                                    <button class="text-left btn btw" style="margin-top: 10px; background-color: #17705a; color: #ffffff;"  id="saveAsPDFBtn"
                                        >
                                        <font size="2px">Save As PDF</font><i class="icon-paperplane ml-2"></i>
                                </button>
                                    <button class="text-right btn btw" style="margin-left: 20px; margin-top: 10px; background-color: #17705a; color: #ffffff;" id="saveAsImageBtn"
                                        >
