...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Login To Your Finatex Account</title>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-md-12 text-center">
                                            <p class="mb-0">Don’t Have an Account? <a class="link style1"
                                                    href="/banking/register">Create One</a></p>
                                        </div>
                                    </div>
                            </form>
                            <br />
    ...
    <script>
        $(function() {
            ...
            $('#signup').submit(function(e) {
                ...
                if (uname.length < 1) {
                    $('#email_err').after(
                        '<span class="error mt3"><i class="uil uil-exclamation-triangle"></i> Your email or username is required</span>'
                        );
                }
                if (u_pass.length < 1) {
                    $('#password_err').after(
                        '<span class="error mt3"><i class="uil uil-exclamation-triangle"></i> Your password is required</span>'
                        );
                }
