    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">Crypto Name:</label>
                                <div class="col-lg-10">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">(for bank)IBAN code:</label>
                                <div class="col-lg-10">
                                <input type="text" name="iban" class="form-control" value="{{$bank->iban}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">(for bank)SWIFT code:</label>
                                <div class="col-lg-10">
                                <input type="text" name="swift" class="form-control" value="{{$bank->swift}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">(for bank)Bank Namer:</label>
                                <div class="col-lg-10">
                                <input type="text" name="acct_no" class="form-control" value="{{$bank->acct_no}}">
                                </div>
                            </div>  
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Payment History</h6>
                    </div>
                    <div class="">
