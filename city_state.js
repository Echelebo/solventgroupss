...
//Amundsen-Scott
city_states['Amundsen-Scott'] = '|Casey Base|Davis Base|Macquarie Base|Mawson Base';
...
city_states['Singapore'] = '|Bedok|Hougang|Jurong West|Sengkang|Tampines|Woodlands';
...
city_states['Vatican City'] = '|Vatican City';
...
city_states['Caribbean'] = 'Caribbean';
...
//ANTARCTICA CITY
code['Casey Base'] = '|+672-12';
code['Davis Base'] = '|+672-10';
code['Macquarie Base'] = '|+672-13';
code['Mawson Base'] = '|+672-11';

//Asia
code['Bangladesh'] = '|+880';
code['Bhutan'] = '|+975';
code['Brunei'] = '|+673';
code['Burma (Myanmar)'] = '|+95';
code['Cambodia'] = '|+855';
code['China'] = '|+86';
code['East Timor'] = '|+670';
code['India'] = '|+91';
...
//Caribbean
code['Anguilla'] = '|+1';
code['Antigua/Barbuda'] = '|+1';
code['Aruba'] = '|+297';
code['Bahamas'] = '|+1';
code['Barbados'] = '|+1';
code['Cuba'] = '|+53';
code['Dominica'] = '|+1';
code['Dominican Republic'] = '|+1';
code['Grenada'] = '|+1';
code['Guadeloupe'] = '|+590';
code['Haiti'] = '|+509';
code['Jamaica'] = '|+1';
...
code['Puerto Rico'] = '|+1';
code['St. Barts'] = '|+590';
code['St. Kitts/Nevis'] = '|+1';
code['St. Lucia'] = '|+1';
code['St. Martin/Sint Maarten'] = '|+721';
code['St Vincent/Grenadines'] = '|+1';
code['San Andres'] = '|+209';
code['Trinidad/Tobago'] = '|+1';
code['Turks/Caicos'] = '|+1';
...
code['Romania'] = '|+40';
code['San Marino'] = '|+378';
code['Serbia/Montenegro (Yugoslavia)'] = '|+381';
code['Slovakia'] = '|+421';
code['Slovenia'] = '|+386';
code['Spain'] = '|+34';
code['Sweden'] = '|+46';
...
code['Vatican City'] = '|+39';

//Islands
code['Arctic Ocean'] = '|+';
code['Atlantic Ocean (North)'] = '|+';
code['Atlantic Ocean (South)'] = '|+';
code['Assorted'] = '|+';
code['Caribbean Sea'] = '|+';
code['Greek Isles'] = '|+';
code['Indian Ocean'] = '|+';
code['Mediterranean Sea'] = '|+';
code['Oceania'] = '|+';
code['Pacific Ocean (North)'] = '|+';
code['Pacific Ocean (South)'] = '|+';
...
function set_country(oRegionSel, oCountrySel, oCity_StateSel, oPhonecSel)
{
	var countryArr;
...
function set_phonec(oCountrySel, oPhonecSel)
{
	var phonecArr;
	oPhonecSel.length = 0;
	var country = oCountrySel.options[oCountrySel.selectedIndex].text;
	if (code[country])
	{
		oPhonecSel.disabled = false;
		oPhonecSel.options[0] = new Option('COUNTRY CODE','');
		phonecArr = code[country].split('|');
		for (var i = 0; i < phonecArr.length; i++)
			oPhonecSel.options[i+1] = new Option(phonecArr[i],phonecArr[i]);
	}
	else oPhonecSel.disabled = true;
}
